  ...
  return (
    <div className={isV2Ui ? 'gn-v2-sidebar-redesign' : undefined} style={{ display: 'flex', height: '100%', minHeight: 0 }}>
        ...
        <div
            ...
            className={`sidebar-tree-scroll-shell${isV2Ui ? ' gn-v2-explorer-tree-shell' : ''}${sidebarTreeDragNodeType === 'connection' ? ' is-host-tree-dragging' : ''}${sidebarTreeDropPreview ? ' has-host-group-drop-preview' : ''}`}
        ...
        >
            <div className="sidebar-tree-scroll-content">
                <Tree
                    ...
                    itemHeight={isV2Ui ? 30 : undefined}
                    itemHeightResolver={isV2Ui ? resolveSidebarTreeRowHeight : undefined}
