...
const driverModalCatalogAliases: Record<string, CatalogAlias> = {
  ...
  "driver.modal.card.optionalUpdate.dismiss": { aliasKey: "driver_manager.message.optional_update_dismiss" },
  ...
  "driver.modal.card.status.optionalUpdate": { aliasKey: "driver_manager.status.optional_component_update" },
  ...
  "driver.modal.stats.canUpdate": { aliasKey: "driver_manager.status.can_update" },
